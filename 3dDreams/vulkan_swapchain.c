...
static void create(vulkan_swapchain* swapchain, u32 w, u32 h)
{
}

static void destroy(vulkan_swapchain* swapchain)
{
}

static bool vulkan_swapchain_create(hw_arena* arena, vulkan_context* context)
{
	create(&context->swapchain, context->framebuffer_width, context->framebuffer_height);
