...
static bool vulkan_framebuffer_create(vulkan_context* context)
{
   for(u32 i = 0; i < context->swapchain.image_count; ++i)
   {
      ...
      framebuffer_info.width = context->swapchain.info.surface_capabilities.currentExtent.width;
      framebuffer_info.height = context->swapchain.info.surface_capabilities.currentExtent.height;
